...
class WePayments extends StatefulWidget {
  const WePayments({super.key});

  @override
  State<WePayments> createState() => _WePaymentsState();
}

class _WePaymentsState extends State<WePayments> {
  final PaymentsComponents _paymentsComponents = PaymentsComponents();
  @override
                    ...
                    Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            _paymentsComponents.mypaymentBox(
